...
const config = {
  ...
  tagline: 'Master cloud platforms, databases, and technologies with comprehensive learning materials',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} TechLearn Platform. Built with Docusaurus.`,
      },
      prism: {
